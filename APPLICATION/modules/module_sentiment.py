...
@st.cache_data
def load_data():
    df_volontaires = pd.read_csv('https://raw.githubusercontent.com/hyontnick/qganalytics_blood_dashboard_indabax/main/APPLICATION/datas/volontaire_clean_corrige.csv')
